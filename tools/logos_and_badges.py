...
def get_competition_logo(competition, year=None, logo_brighten=False):
    ...
    if competition in ['UEFA Super Cup', 'Super Cup', 'USC']:
        url = "https://brandlogos.net/wp-content/uploads/2017/06/uefa-super-cup-logo.png"
...
def get_team_badge_and_colour(team, hoa='home'):
    ...
    if team in ['Burnley FC', 'Burnley']:
        url = "https://brandlogos.net/wp-content/uploads/2023/07/burnley_fc-logo_brandlogos.net_vh9ys.png"
        #cmap = cm.get_cmap('BuPu') if hoa == 'home' else cm.get_cmap('Blues')
